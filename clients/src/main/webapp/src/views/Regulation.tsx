    ...
    return (<>
        ...
        >
            <Meta
                ...
                description={'Released: ' + new Date(Date.parse(regulation.releaseDate)).toDateString()}
            />
            <p className='mt-5'>
        ...
        {isDrawerVisible &&
        <UpdateRegulation regulation={regulation} isVisible={isDrawerVisible} setIsVisible={setIsDrawerVisible}/>}
    </>)
}
